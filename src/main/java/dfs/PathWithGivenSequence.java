...
/**
 * Time: O(N); 'N' is the total number of nodes in the tree.we traverse each node once.
 * Space: O(N) in the worst case. This space will be  used to store the recursion stack. This worst case will
