...
/**
 * Time: Sorting the array will take O(N*logN). Overall searchQuadruplets() will take O(N*logN+N^3),
 * which is asymptotically equivalent to O(N^3)
 * Space: The space complexity of the above algo will be O(N) which is required for sorting.
 */