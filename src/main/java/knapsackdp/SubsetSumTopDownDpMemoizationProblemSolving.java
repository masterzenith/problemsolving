...
public class SubsetSumTopDownDpMemoizationProblemSolving {
    ...
    public static void main(String[] args) {
        SubsetSumTopDownDpMemoizationProblemSolving ss = new SubsetSumTopDownDpMemoizationProblemSolving();
        int[] num = {1, 1, 2, 3};
