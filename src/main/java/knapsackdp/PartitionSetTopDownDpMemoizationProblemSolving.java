...
public class PartitionSetTopDownDpMemoizationProblemSolving {
    ...
    public static void main(String[] args) {
        PartitionSetTopDownDpMemoizationProblemSolving ps = new PartitionSetTopDownDpMemoizationProblemSolving();
        int[] num = {1, 2, 3, 9};
