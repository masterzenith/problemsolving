...
/**
 * Time: insertNum() will be O(logN) due to the insertion in the heap. The time complexity of findMedian()
 * will be O(1) as we can find the median from the top elements of the heaps.
 * Space: O(N); as at any time , we will be storing all the numbers.
 */