 ...
 * Space: O(M) since in the worst case, the whole pattern can have distinct characters which will go into the hashmap
 * In the worst case, we also need O(N) space for resulting substring, which will happen when input string is a permutation
 * of the pattern.*/
