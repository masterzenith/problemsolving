...
/**
 * Time: Since we’ll be going through all the elements of all arrays and will be removing/adding one
 ...
 * Space: The space complexity will be O(K)because,
 * at any time, our min-heap will be storing one number from all the ‘K’ input arrays.
 */